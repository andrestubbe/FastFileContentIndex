...
public class Demo {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("=================================================");
        System.out.println("   FastFileContentIndex 0.1.0 High-Speed Search Demo");
        System.out.println("=================================================\n");
        ...
        System.out.printf("⚡ Indexed %d files in %d ms%n%n", index.getIndexedFileCount(), indexTime);

        String[] searchQueries = {"TrigramBloomFilter", "search", "FastFileContentIndex"};

        for (String query : searchQueries) {
            System.out.println("--- Search Query: \"" + FastANSI.fg(0x7A, 0xA2, 0xF7) + query + FastANSI.RESET + "\" ---");
